export const RETAIL_SCHEMA = `
  ...
  ALTER TABLE sale_items ADD COLUMN IF NOT EXISTS refunded NUMERIC(12, 3) NOT NULL DEFAULT 0;
  ALTER TABLE sales ADD COLUMN IF NOT EXISTS refund_total NUMERIC(12, 2) NOT NULL DEFAULT 0;
