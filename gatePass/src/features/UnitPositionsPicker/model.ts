...
export const ESTIMATED_ITEM_HEIGHT = 96
export const EMPLOYEE_PLACEHOLDER = 'ФИО или логин сотрудника'
export const ASSIGN_LABEL = 'Назначить сотрудника'
export const CHANGE_TOOLTIP = 'Сменить сотрудника'
export const UNASSIGN_TOOLTIP = 'Снять с должности'
export const CANCEL_PICK_TOOLTIP = 'Отменить выбор'
