...
export const sideColumn: StyleDesc = {
  display: 'flex',
  flexDirection: 'column',
  gap: theme.spacing.sm,
  width: theme.size.sidebar + theme.size.filterField,
  minHeight: 0,
}
...
export const actionLabel: StyleDesc = {
  fontFamily: theme.font.family,
...
export const filterBox: StyleDesc = { width: theme.size.sidebar }
